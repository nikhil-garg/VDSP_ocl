...
def evaluate_mnist_multiple(args):
    ...
    input_neurons_args = {
            ...
            "neuron_type":MyLIF_in_v2(tau_rc=args.tau_in,min_voltage=-1.8, amplitude=args.amp_neuron, tau_ref=args.tau_ref_in)
    ...
    last_weight = (0.0000085 + ((0.0085-0.0000085)*weights[-1]))*200

...
if __name__ == '__main__':
	...
	parameters = dict(
		...
		, dt = [0.005]
		, n_neurons = [50]
		, inhibition_time = [10,15,20]
		, tau_ref_in = [0.002,0.01]
		, tau_ref_out = [0.002,0.01]
		, inc_n = [0.01]
		, tau_n = [1]
		, synapse_layer_1=[0.004,0.005]
		, winit_max = [1]
		, vprog_increment = [0]

...
import os
from mnist_vdsp_multiple_var_dw import *
from utilis import *
...
if __name__ == '__main__':
	...
	for args.vprog,args.input_nbr,args.g_max,args.tau_in,args.tau_out,args.gain_in,args.gain_out,args.bias_in,args.bias_out,args.thr_out,args.inhibition_time,args.lr,args.presentation_time,args.dw_var,args.seed in product(*param_values):
		...
		pwd = os.getcwd()
		# args.vthn = args.vthp
		accuracy, weights = evaluate_mnist_multiple_var_dw(args)

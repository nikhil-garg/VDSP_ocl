...
if __name__ == '__main__':
	...
	parameters = dict(
		...
		, alpha= [2,4,1]
		, iterations=[1]
		, presentation_time = [0.35,0.30,0.25,0.40]
		, pause_time = [0]
		, dt = [0.005]
		, n_neurons = [10]
		, inhibition_time = [10]

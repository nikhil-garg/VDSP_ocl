...
def evaluate_mnist_multiple_tio2(args):
    ...
    input_neurons_args = {
            ...
            "neuron_type":MyLIF_in(tau_rc=args.tau_in,min_voltage=-2, amplitude=args.g_max)
    ...
    with model:
        ...
        w = nengo.Node(CustomRule_post_v5(**learning_args), size_in=n_in, size_out=n_neurons)
